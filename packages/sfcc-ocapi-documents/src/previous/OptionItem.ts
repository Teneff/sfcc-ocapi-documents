...
export interface OptionItem extends WithCustom<OCAPI.Custom.OptionItem> {
  /**
  ...
  item_text: string;
  /**
   * mandatory=true, maxLength=256	The id of the option.
   */
  option_id: string;
  /**
  ...
  /**
   * mandatory=true, maxLength=256	The id of the option value.
   */
  ...
  /**
   * maxNumberValue=999.0, minNumberValue=0.0	The quantity of the products represented by this item.
   */
  quantity: number;
  /**
